...
router.post('/categorias', [auth, validate(categoriaSchema)], categoriaController.crearCategoria);
...
router.put('/categorias/:id',  [auth, validate(categoriaSchema)], categoriaController.updateCategoria);
