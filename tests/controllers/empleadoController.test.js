...
describe('empleadoController', () => {
    ...
    describe('GET /api/empleados/:id', () => {
        it('should retrieve a specific empleado by ID', async () => {
            const empleadoId = "1";
            const mockEmpleado = { /* Datos del empleado */
                id: empleadoId,
                nick: 'juan123',
                nombre: 'Juan',
                apellido: 'Perez',
            ...
            expect(empleadoService.getEmpleadoById).toHaveBeenCalledWith(empleadoId);
        });
    ...
    describe('DELETE /api/empleados/:id', () => {
        it('should delete an empleado', async () => {
            ...
            expect(empleadoService.deleteEmpleado).toHaveBeenCalledWith(empleadoId);
        });
    ...
    describe('POST /api/login', () => {
        it('should successfully login an empleado and return a token', async () => {
            ...
            expect(res.body.empleado).toEqual(expect.objectContaining({
                id: mockEmpleado.id,
            ...
            expect(empleadoService.authenticate).toHaveBeenCalledWith(credentials.nick, credentials.password);
        });
        ...
        it('should return an error if credentials are incorrect', async () => {
            ...
            expect(res.body).toHaveProperty('message', 'Usuario o contraseña incorrecta');
        });
    ...
    describe('PUT /api/resetPassword/:id', () => {
        it('should successfully reset the password of an empleado', async () => {
            const empleadoId = "1";
            const passwordData = { currentPassword: 'oldPassword123', newPassword: 'newPassword123' };
            empleadoService.authenticateById.mockResolvedValue({ /* datos del empleado */
                id: empleadoId,
                nick: 'juan123',
                nombre: 'Juan',
                apellido: 'Perez',
            ...
            expect(empleadoService.authenticateById).toHaveBeenCalledWith(empleadoId, passwordData.currentPassword);
            expect(empleadoService.resetPassword).toHaveBeenCalledWith(empleadoId, passwordData.newPassword);
        });
        ...
        it('should return an error if the current password is not sent', async () => {
            ...
            expect(res.body).toHaveProperty('message', "\"currentPassword\" is required");
        });
