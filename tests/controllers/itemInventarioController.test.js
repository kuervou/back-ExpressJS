...
describe('itemInventarioController', () => {
    ...
    describe('POST /api/itemsInventario', () => {
        it('should create a new itemInventario', async () => {
            ...
            expect(itemInventarioService.crearItemInventario).toHaveBeenCalledWith(
    ...
    describe('GET /api/itemsInventario', () => {
        it('should retrieve a list of items with pagination', async () => {
            ...
            expect(itemInventarioService.getItemsInventario).toHaveBeenCalledWith(expect.objectContaining({ 
                page: 1, 
                limit: 10 
            }));
        });
    ...
    describe('GET /api/itemsInventario/:id', () => {
        it('should retrieve a specific itemInventario by ID', async () => {
            ...
            itemInventarioService.getItemInventarioById.mockResolvedValue(mockItem);
            ...
            expect(itemInventarioService.getItemInventarioById).toHaveBeenCalledWith(itemId);
        });
        ...
        it('should return an error when itemInventario with specified ID does not exist', async () => {
            ...
            expect(res.body).toHaveProperty('message', 'ItemInventario no encontrado');
        });
    });
    ...
    describe('PUT /api/itemsInventario/:id', () => {
        it('should update an itemInventario', async () => {
            const itemId = "1";
            const updateData = { /* Datos para actualizar */
                nombre: 'producto1',
                descripcion: 'Descripción del Producto1',
                stock: 100,
                costo: 50,
            ...
            expect(res.statusCode).toEqual(200);
            expect(res.body).toHaveProperty('message', 'ItemInventario actualizado');
            expect(itemInventarioService.updateItemInventario).toHaveBeenCalledWith(itemId, ...Object.values(updateData));
        });
    ...
    describe('DELETE /api/itemsInventario/:id', () => {
        it('should delete an itemInventario', async () => {
            ...
            expect(res.statusCode).toEqual(200);
            expect(res.body).toHaveProperty('message', 'ItemInventario eliminado');
            expect(itemInventarioService.deleteItemInventario).toHaveBeenCalledWith(itemId);
        });
    ...
    describe('PUT /api/itemsInventario/:id/stock', () => {
        it('should update the stock of an itemInventario', async () => {
            ...
            itemInventarioService.updateStock.mockResolvedValue({ /* datos actualizados del item */
                id: itemId,
                nombre: 'Producto1',
                descripcion: 'Descripción del Producto1',
                stock: 110,
            ...
            expect(res.statusCode).toEqual(200);
            expect(itemInventarioService.updateStock).toHaveBeenCalledWith(itemId, stockData.amount);
