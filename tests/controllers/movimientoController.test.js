...
describe('movimientoController', () => {
    ...
    describe('GET /api/movimientos/caja/:id', () => {
        ...
        it('should return 200 and movimientos for a caja', async () => {
            ...
            cajaService.getCajaById.mockResolvedValue({ id: 1, /* otros datos de la caja */ });
            movimientoService.getMovimientosByCajaId.mockResolvedValue(mockMovimientos);
        ...
        expect(movimientoService.getMovimientosByCajaId).toHaveBeenCalledWith("1", { page: 1, limit: 10 });
        ...
        it('should return 404 when the caja is not found', async () => {
            ...
            expect(response.statusCode).toBe(404);
            expect(response.body).toHaveProperty('message', 'Caja no encontrada');
        });
        ...
        it('should return 404 when movimientos for a caja are not found', async () => {
            ...
            expect(response.statusCode).toBe(404);
            expect(response.body).toHaveProperty('message', 'Movimientos no encontrados');
        });
