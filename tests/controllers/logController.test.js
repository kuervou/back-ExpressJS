...
describe('logController', () => {
    ...
    describe('POST /api/log/abrirBotella', () => {
        it('should open a bottle', async () => {
            ...
            const mockLog = { /* Respuesta simulada del log */
                id: 1,
                itemInventarioId: 1,
                empleadoId: 1,
            ...
            expect(logService.abrirBotella).toHaveBeenCalledWith(logData.itemInventarioId, logData.empleadoId);
        });
    ...
    describe('POST /api/log/cerrarBotella', () => {
        it('should close a bottle', async () => {
            ...
            expect(res.body).toHaveProperty('message', 'La botella se cerró correctamente.');
        });
        ...
        it('should not close a bottle', async () => {
            ...
            expect(res.body).toHaveProperty('message', 'No se pudo cerrar la botella, probablemente no exista un registro de botella abierta para el item de inventario especificado.');
        });
    ...
    describe('GET /api/logs/:itemInventarioId', () => {
        it('should retrieve logs for an itemInventario', async () => {
            ...
            const mockLogs = [/* Array de logs simulados */];
            ...
            expect(logService.getLogs).toHaveBeenCalledWith(itemInventarioId, 1, 10);
        });
