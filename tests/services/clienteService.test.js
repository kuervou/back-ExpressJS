...
describe('crearCliente', () => {
    it('should successfully create a new cliente', async () => {
        ...
        const result = await clienteService.crearCliente(mockCliente.nombre, mockCliente.apellido, mockCliente.telefono);
    ...
    it('should throw an error when cliente with the same nombre and apellido already exists', async () => {
        ...
        await expect(clienteService.crearCliente(mockCliente.nombre, mockCliente.apellido, mockCliente.telefono))
            .rejects
            .toThrow('Ya existe un cliente con esa combinación de nombre y apellido');
    });
});
...
describe('getClienteById', () => {
    it('should retrieve a cliente by its ID', async () => {
        const mockCliente = { id: 1, nombre: 'Juan', apellido: 'Pérez', telefono: '123456789' };
...
describe('updateCliente', () => {
    it('should update an existing cliente', async () => {
        ...
        const result = await clienteService.updateCliente(1, mockCliente.nombre, mockCliente.apellido, mockCliente.telefono, mockCliente.cuenta);
    ...
    it('should throw an error when cliente name and apellido already exists in another cliente', async () => {
        ...
        clienteRepository.findByNombreAndApellido.mockResolvedValue({ id: 2, ...mockCliente });

        await expect(clienteService.updateCliente(1, mockCliente.nombre, mockCliente.apellido, mockCliente.telefono, mockCliente.cuenta))
            .rejects
            .toThrow('Ya existe un cliente con esa combinación de nombre y apellido');
    });
});
